...
public partial class BookStoresDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCF729CA341");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE1124A06EF");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A5A9E672C2");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F222FDEB328C");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC9A157FFB");
